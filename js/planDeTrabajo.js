$(document).ready(function(){
	$('#tablaPlanDeTrabajo').load("planDeTrabajo/tablaPlanDeTrabajo.php");
	var fechaA = new Date();
...
function agregarPlanDeTrabajo() {
     if ($('#plan_trabajo').val() !== "") {
        var archivoInput = document.getElementById('plan_trabajo');
    ...
    var formData = new FormData(document.getElementById("frmPlanDeTrabajo"));
    $.ajax({
        url: "../procesos/planDeTrabajo/agregarPlanDeTrabajo.php",
        type: "POST",
        dataType: "html",
        data: formData,
        cache: false,
