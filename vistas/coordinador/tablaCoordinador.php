...
<div class="table-responsive">
		<table id="tablaCoordinadorDataTable" class="table-striped table-bordered
		...
		<tr>
			...
			<?php 
				$idCoordinador = $mostrar['id_coordinador'];
			...
			?>
			<td>
				<span  data-toggle="modal" data-target="#agregarArchivosCoordinador" class="btn btn-success btn-sm <?php echo $disabled; ?>" 
					onclick="obtenerIdCoordinador('<?php echo $mostrar['id_coordinador'] ?>')">
					<span class="far fa-file-alt"></span>
				</span>
			</td>

			<td>
				<span  data-toggle="modal" data-target="#modalActualizarCoordinador" class="btn btn-warning btn-sm <?php echo $disabled; ?>" 
					onclick="obtenerDatosCoordinador('<?php echo $mostrar['id_coordinador'] ?>')">
			...
			<td>
				<span style="<?php echo $estilo; ?>font-size: 23px;cursor: pointer;" onclick="estatusCoordinador('<?php echo $mostrar['id_coordinador'] ?>','<?php echo $activo ?>')">
...
<script type="text/javascript">
	$(document).ready(function(){
		var t = $('#tablaCoordinadorDataTable').DataTable({
			//for responsive
			"columnDefs": [ {
				"searchable": false,
				"orderable": false,
